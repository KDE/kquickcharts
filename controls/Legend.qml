...
Control {
    ...
    property int flow
    onFlowChanged: Logging.deprecated("Legend", "flow", "5.80", "Legend uses a dynamic column layout now")
    property int sourceIndex
    onSourceIndexChanged: Logging.deprecated("Legend", "sourceIndex", "5.80", "Use Chart's indexingMode property")

    property bool valueVisible: false
    onValueVisibleChanged: Logging.deprecated("Legend", "valueVisible", "5.80", "Customise the delegate instead")
    property real valueWidth: -1
    onValueWidthChanged: Logging.deprecated("Legend", "valueWidth", "5.80", "Customise the delegate instead")
    property bool colorVisible: true
    onColorVisibleChanged: Logging.deprecated("Legend", "colorVisible", "5.80", "Customise the delegate instead")
    property real colorWidth: 0
    onColorWidthChanged: Logging.deprecated("Legend", "colorWidth", "5.80", "Customise the delegate instead")

    default property var _children: legend.children
