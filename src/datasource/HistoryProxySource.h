...
public:
     ...
     *
     * These determine the value returned by \l itemCount and what happens
     * when requesting an item that does not have a value in the history.
     *
     * \value DoNotFill
     *        Do not fill with any items. The source's \l itemCount will be
     *        equal to the number of items in the history.
     * \value FillFromStart
     *        Fill with empty values, starting at 0. The source's \l itemCount
